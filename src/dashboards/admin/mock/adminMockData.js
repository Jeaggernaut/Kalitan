export const adminMockData = {
  dashboard: {
    ...
    activity: [
      ...
      { id: 3, title: 'Nueva asociacion registrada', detail: 'Red Solidaria Poza Rica envio solicitud de verificacion', time: 'Ayer, 06:20 PM', type: 'Asociacion' },
      { id: 4, title: 'Nuevo usuario registrado', detail: 'Juan Perez se registro como voluntario', time: 'Ayer, 04:10 PM', type: 'Usuario' },
      { id: 5, title: 'Reporte recibido', detail: 'Alimentos caducados reportados en Mercado Poza Rica Norte', time: 'Ayer, 02:35 PM', type: 'Alerta' },
    ],
  ...
  users: [
    ...
    { id: 3, name: 'Mariana Soto', email: 'mariana@redsolidariapr.org', type: 'Asociacion', status: 'Pendiente', registeredAt: '19/05/2026' },
    ...
    { id: 6, name: 'Diego Salas', email: 'diego@comedorcazones.org', type: 'Asociacion', status: 'Activo', registeredAt: '16/05/2026' },
  ],
  businesses: [
    ...
    { id: 3, name: 'Lacteos Poza Rica', owner: 'Elena Torres', status: 'Pendiente', subscription: 'Pendiente', activeSurpluses: 0, lastActivity: 'Ayer, 01:12 PM' },
    { id: 4, name: 'Mercado Poza Rica Norte', owner: 'Hector Diaz', status: 'Observacion', subscription: 'Activa', activeSurpluses: 3, lastActivity: 'Hace 3 dias' },
  ],
  associations: [
    { id: 1, name: 'Red Solidaria Poza Rica', contact: 'Mariana Soto', status: 'Pendiente', recentDeliveries: 0, lastActivity: 'Ayer, 06:20 PM' },
    { id: 2, name: 'Comedor Comunitario Cazones', contact: 'Diego Salas', status: 'Activo', recentDeliveries: 12, lastActivity: 'Hoy, 08:45 AM' },
    { id: 3, name: 'Puente Comunitario Poza Rica', contact: 'Nora Luna', status: 'Activo', recentDeliveries: 7, lastActivity: 'Ayer, 11:15 AM' },
    { id: 4, name: 'Casa Hogar Poza Rica', contact: 'Sofia Merino', status: 'Suspendido', recentDeliveries: 2, lastActivity: 'Hace 6 dias' },
  ],
  surpluses: [
    ...
    { id: 3, food: 'Productos lacteos', business: 'Lacteos Poza Rica', quantity: '20 kg', status: 'Vencido', date: '23/05/2026' },
    { id: 4, food: 'Ensaladas preparadas', business: 'Bistro Verde', quantity: '8 kg', status: 'Rescatado', date: '22/05/2026' },
    { id: 5, food: 'Despensa seca', business: 'Mercado Poza Rica Norte', quantity: '18 kg', status: 'Publicado', date: '22/05/2026' },
  ],
  reports: {
    summary: [
